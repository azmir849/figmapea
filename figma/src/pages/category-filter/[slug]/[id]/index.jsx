...
import { allcategoryUrl, allpostsUrl, filterpostsUrl, tagpostsUrl } from '@/utils/api/api';
...
export async function getStaticProps({ params }) {
    ...
    const res = await fetch(`${filterpostsUrl}/${params.id}`);
...
export async function getStaticPaths() {
    ...
    const paths = [];
    categories.categorys.forEach((cat) => paths.push(`/category-filter/${cat.category_slug}/${cat.id}`));
