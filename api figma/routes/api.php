...
Route::prefix('/front')->group(function () {
    ...
    Route::get('/category-tag-posts/{id}', [GetPostController::class, 'getPostByCategoryTag']);
    Route::get('/category-header-posts/{id}', [GetPostController::class, 'getPostByCategoryHeader']);
    Route::get('/category-filter-posts/{id}', [GetPostController::class, 'getPostByCategoryFilter']);
